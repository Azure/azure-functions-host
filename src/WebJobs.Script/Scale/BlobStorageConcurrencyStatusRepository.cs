...
namespace Microsoft.Azure.WebJobs.Host
{
    ...
    internal class BlobStorageConcurrencyStatusRepository : IConcurrencyStatusRepository
    {
        ...
        public BlobStorageConcurrencyStatusRepository(IConfiguration configuration, IHostIdProvider hostIdProvider, ILoggerFactory loggerFactory, IAzureStorageProvider azureStorageProvider)
        {
