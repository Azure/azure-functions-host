...
namespace Microsoft.Azure.WebJobs.Script.Scale
{
    public class HostPerformanceManager : IDisposable
    {
        ...
        internal async Task<bool> ProcessThresholdsExceeded(ILogger logger = null)
        {
            ...
            // is not running.
            var throttleManager = _serviceProvider.GetHostServiceOrNull<IConcurrencyThrottleManager>();
        ...
        {
            var dispatcherFactory = _serviceProvider.GetHostServiceOrNull<IFunctionInvocationDispatcherFactory>();
