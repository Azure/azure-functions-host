...
namespace Microsoft.Azure.WebJobs.Script
{
    public class HostFunctionMetadataProvider : IFunctionMetadataProvider
    {
        ...
        public async Task<ImmutableArray<FunctionMetadata>> GetFunctionMetadataAsync(IEnumerable<RpcWorkerConfig> workerConfigs, bool forceRefresh, IEnvironment environment = null)
        {
