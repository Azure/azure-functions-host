...
namespace Microsoft.Azure.WebJobs.Script.Diagnostics.Extensions
{
    internal static class LoggerExtension
    {
        ...
        private static readonly Action<ILogger, string, string, Exception> _autorestGeneratedFunctionApplication =
            LoggerMessage.Define<string, string>(
            LogLevel.Information,
            new EventId(332, nameof(AutorestGeneratedFunctionApplication)),
            "autorest_generated.json file found generated by Autorest (https://aka.ms/stencil) | file content: {newLine}{sanitizedAutorestJson}");
...
Lock file hash: {currentLockFileHash}";
        ...
        public static void AutorestGeneratedFunctionApplication(this ILogger logger, string sanitizedAutorestJson)
        {
            ...
            _autorestGeneratedFunctionApplication(logger, newLine, sanitizedAutorestJson, null);
        }

        public static void IncorrectAutorestGeneratedJsonFile(this ILogger logger, string contents)
        {
            string newLine = NewLine;
            _incorrectAutorestGeneratedJSONFile(logger, newLine, contents, null);
        }
    }
}
