...
namespace Microsoft.Azure.WebJobs.Script.Diagnostics
{
    ...
    internal class FileLogger : ILogger
    {
        ...
        public void Log<TState>(LogLevel logLevel, EventId eventId, TState state, Exception exception, Func<TState, Exception, string> formatter)
        {
            ...
            string functionName = scopeProperties["MS_FunctionName"].ToString();

            // this function name starts with "Function.", but file paths do not include this
            ...
            // FileTraceWriter doesn't use these properties, but adding them for completeness
