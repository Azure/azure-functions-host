...
namespace Microsoft.Azure.WebJobs.Script.Workers.Http
{
    public class DefaultHttpWorkerService : IHttpWorkerService
    {
            ...
            IOptions<ScriptJobHostOptions> scriptHostOptions, IHttpProxyService httpProxyService)
        {
            ...
            _destinationPrefix = new UriBuilder(WorkerConstants.HttpScheme, WorkerConstants.HostName, (int)_httpWorkerOptions.Port).Uri;
        ...
        internal string BuildAndGetUri(string pathValue = null)
        {
            ...
            {
                return new UriBuilder(WorkerConstants.HttpScheme, WorkerConstants.HostName, (int)_httpWorkerOptions.Port).ToString();
            }
            return new UriBuilder(WorkerConstants.HttpScheme, WorkerConstants.HostName, (int)_httpWorkerOptions.Port, pathValue).ToString();
        }
