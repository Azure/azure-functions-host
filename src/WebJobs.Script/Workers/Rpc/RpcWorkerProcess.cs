...
namespace Microsoft.Azure.WebJobs.Script.Workers.Rpc
{
    internal class RpcWorkerProcess : WorkerProcess
    {
        ...
        {
            var workerContext = new RpcWorkerContext(Guid.NewGuid().ToString(), RpcWorkerConstants.DefaultMaxMessageLengthBytes, _workerId, _workerProcessArguments, _scriptRootPath, _serverUri, null, _rpcWorkerDescription.PalEmulated, _rpcWorkerDescription.PalPackagePath, _rpcWorkerDescription.PalExePath);
