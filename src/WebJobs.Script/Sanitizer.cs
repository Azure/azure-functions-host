...
namespace Microsoft.Azure.WebJobs.Logging
{
    ...
    internal static class Sanitizer
    {
        ...
        internal static readonly string[] CredentialTokens = new string[] { "Token=", "DefaultEndpointsProtocol=http", "AccountKey=", "Data Source=", "Server=", "Password=", "pwd=", "&amp;sig=", "&sig=", "?sig=", "SharedAccessKey=", "x-functions-key =" };
