...
#endif
{
    /// <summary>Represents information about a function instance that has completed.</summary>
#if PUBLICPROTOCOL
    public class FunctionCompletedSnapshot : FunctionStartedSnapshot
#else
    internal class FunctionCompletedSnapshot : FunctionStartedSnapshot
#endif
    {
