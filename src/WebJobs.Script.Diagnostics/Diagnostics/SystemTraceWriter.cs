...
namespace Microsoft.Azure.WebJobs.Script.WebHost.Diagnostics
{
    public class SystemTraceWriter : TraceWriter
    {
        ...
        private IScriptSettingsManagner _settingsManager;
        private string _appName;
        private string _subscriptionId;

        public SystemTraceWriter(IEventGenerator eventGenerator, IScriptSettingsManagner settingsManager, TraceLevel level) : base(level)
        {
