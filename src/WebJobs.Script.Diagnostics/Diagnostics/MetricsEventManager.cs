...
namespace Microsoft.Azure.WebJobs.Script.WebHost.Diagnostics
{
    public class MetricsEventManager : IDisposable
    {
        ...
        public MetricsEventManager(IScriptSettingsManagner settingsManager, IEventGenerator generator, int functionActivityFlushIntervalSeconds, int metricsFlushIntervalMS = DefaultFlushIntervalMS)
        {
        ...
        internal void HostStarted(IScriptHost scriptHost)
        {
        ...
        /// </summary>
        public static string GetAggregateKey(string eventName, string functionName = null)
        {
        ...
        public virtual void TimerFlush(object state)
        {
