...
namespace Microsoft.Azure.WebJobs.Script.WebHost.Diagnostics
{
    ...
    public sealed class FunctionsDiagnosticLogsEventSource : ExtendedEventSource
    {
        internal static readonly FunctionsDiagnosticLogsEventSource Instance = new FunctionsDiagnosticLogsEventSource();

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1030:UseEventsWhereAppropriate")]
        [Event(65525, Level = EventLevel.Verbose, Channel = EventChannel.Operational, Version = 1)]
        public void RaiseFunctionsDiagnosticEventVerbose(string resourceId, string operationName, string category, string location, string monitorLevel, string properties)
        {
            if (IsEnabled())
            {
                WriteEvent(65525, resourceId, operationName, category, location, monitorLevel, properties);
            }
        }
