...
namespace Microsoft.Azure.WebJobs.Script.WebHost.Diagnostics
{
    internal class LinuxAppServiceEventGenerator : LinuxEventGenerator
    {
            ...
            Action<string> writeEvent = null)
        {
            ...
            WriteEvent(_functionsLogsCategoryLogger.Value, $"Linux App Service Event Generator Initialized, execution log backoff enabled: {executionLogBackoffEnabled}, executionDetails : {functionsHostingConfigOptions.Value.DisableLinuxAppServiceExecutionDetails}");
        }
