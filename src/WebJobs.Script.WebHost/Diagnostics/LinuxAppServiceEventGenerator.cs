...
namespace Microsoft.Azure.WebJobs.Script.WebHost.Diagnostics
{
    internal class LinuxAppServiceEventGenerator : LinuxEventGenerator
    {
            ...
            Action<string> writeEvent = null)
        {
            ...
            _functionsLogsCategoryLogger = loggerFactory.Create(FunctionsLogsCategory, functionsHostingConfigOptions.Value.DisableLinuxAppServiceLogBackoff);
            _functionsMetricsCategoryLogger = loggerFactory.Create(FunctionsMetricsCategory, functionsHostingConfigOptions.Value.DisableLinuxAppServiceLogBackoff);
            _functionsDetailsCategoryLogger = loggerFactory.Create(FunctionsDetailsCategory, functionsHostingConfigOptions.Value.DisableLinuxAppServiceLogBackoff);
        }
