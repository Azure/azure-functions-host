...
namespace Microsoft.Azure.WebJobs.Script.WebHost
{
    public class WebJobsScriptHostService : IHostedService, IScriptHostManager, IServiceProvider, IDisposable
    {
        ...
        private readonly HostBuiltChangeTokenSource<LanguageWorkerOptions> _hostBuiltChangeTokenSource;
            ...
            HostBuiltChangeTokenSource<LanguageWorkerOptions> hostBuiltChangeTokenSource)
        {
            ...
            _hostBuiltChangeTokenSource = hostBuiltChangeTokenSource ?? throw new ArgumentNullException(nameof(hostBuiltChangeTokenSource));
        ...
        private async Task UnsynchronizedStartHostAsync(ScriptHostStartupOperation activeOperation, int attemptCount = 0, JobHostStartupMode startupMode = JobHostStartupMode.Normal)
        {
            ...
            try
            {
                ...
                {
                    _hostBuiltChangeTokenSource.TriggerChange();
                }
