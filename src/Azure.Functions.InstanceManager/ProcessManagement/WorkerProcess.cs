...
namespace Microsoft.Azure.WebJobs.Script.Workers
{
    internal abstract class WorkerProcess : IWorkerProcess, IDisposable
    {
        ...
        private readonly WorkerProcessOptions _workerProcessOptions;
        ...
        internal WorkerProcess(IScriptEventManager eventManager, IProcessRegistry processRegistry, ILogger workerProcessLogger, IWorkerConsoleLogSource consoleLogSource, IMetricsLogger metricsLogger,
            IServiceProvider serviceProvider, ILoggerFactory loggerFactory, IOptions<WorkerProcessOptions> workerProcessOptions, IOptionsMonitor<ScriptApplicationHostOptions> scriptApplicationHostOptions, bool useStdErrStreamForErrorsOnly = false)
        {
            ...
            _workerProcessOptions = workerProcessOptions.Value;
        ...
        public Task StartProcessAsync()
        {
            using (_metricsLogger.LatencyEvent(MetricEventNames.ProcessStart))
            {
                ...
                if (_workerProcessOptions.AssignUserExecutePermissionsIfNotExists)
                {
