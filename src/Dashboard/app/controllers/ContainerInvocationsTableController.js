angular.module('dashboard').controller('ContainerInvocationsTableController',
    function ContainerInvocationsTableController($scope, $rootScope, $http, api, FunctionInvocationSummary) {
