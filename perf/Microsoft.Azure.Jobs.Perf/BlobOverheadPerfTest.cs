    ...
    public static partial class BlobOverheadPerfTest
    {
        ...
        public static void Run(string connectionString)
        {
            ...
            try
            {
                ...
                TimeSpan webJobsSDKTime = RunWebJobsSDKTest();
        ...
        private static TimeSpan RunWebJobsSDKTest()
        {
            Console.WriteLine("Running the WebJobs SDK test...");

            TimeBlock block = new TimeBlock();

            RunWebJobsSDKTestInternal();

            block.End();
            return block.ElapsedTime;
        }

        private static void RunWebJobsSDKTestInternal()
        {
