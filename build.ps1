...
ZipContent $publishTarget "$buildoutput\SiteExtension.Private.$extensionVersion.zip"
...
ZipContent $siteExtensionPath "$buildoutput\SiteExtension.$extensionVersion.zip"
