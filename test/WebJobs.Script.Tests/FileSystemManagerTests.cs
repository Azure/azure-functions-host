...
//        {
//            var fileSystemManager = new TestFileSystemManager(new TestEnvironment());
...
//                fileSystemManager.UpdateEnvironment(environment);
...
//            fileSystemManager.UpdateEnvironment(allSettingsEnvironment);
//            Assert.Equal(fileSystemManager.IsZipDeployment(), expectedOutcome);
//        }
//    }
//}
