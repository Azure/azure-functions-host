...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class HostFunctionMetadataProviderTests
    {
        ...
        public void ReadFunctionMetadata_Succeeds()
        {
            ...
            Assert.Equal(18, metadataProvider.GetFunctionMetadataAsync(workerConfigs, SystemEnvironment.Instance, false, null).Result.Length);
        ...
        public void ReadFunctionMetadata_For_WorkerIndexingFormatApp_Fails()
        {
            ...
            var metadataProvider = new HostFunctionMetadataProvider(optionsMonitor, NullLogger<HostFunctionMetadataProvider>.Instance, _testMetricsLogger);
            var workerConfigs = TestHelpers.GetTestWorkerConfigs();
            Assert.Equal(0, metadataProvider.GetFunctionMetadataAsync(workerConfigs, SystemEnvironment.Instance, false, null).Result.Length);
        }
        ...
        public void ReadFunctionMetadata_With_Retry_Succeeds()
        {
            ...
            var metadataProvider = new HostFunctionMetadataProvider(optionsMonitor, NullLogger<HostFunctionMetadataProvider>.Instance, _testMetricsLogger);
            var workerConfigs = TestHelpers.GetTestWorkerConfigs();
            var functionMetadatas = metadataProvider.GetFunctionMetadataAsync(workerConfigs, SystemEnvironment.Instance, false, null).Result;
