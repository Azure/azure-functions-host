...
namespace Microsoft.Azure.WebJobs.Script.Tests.Extensions
{
    ...
    {
        [Fact]
        public void GetHostServiceOrNull_ReturnsExpectedValue()
        {
            ...
            var result = serviceProviderMock.Object.GetHostServiceOrNull<ITestInterface>();
            Assert.Same(test, result);
        }

        [Fact]
        public void GetHostServiceOrNull_NonScriptHost_ReturnsNull()
        {
            var serviceProviderMock = new Mock<IServiceProvider>(MockBehavior.Strict);
