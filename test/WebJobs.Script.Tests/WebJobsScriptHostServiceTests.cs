...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class WebJobsScriptHostServiceTests
    {
        ...
        private Mock<IFileSystemManager> _fileSystemManager = new Mock<IFileSystemManager>(MockBehavior.Strict);
        ...
        public WebJobsScriptHostServiceTests()
        {
            ...
            _fileSystemManager.Setup(x => x.IsZipDeployment(_loggerFactory.CreateLogger<IFileSystemManager>(), false)).Returns(true);
        }
