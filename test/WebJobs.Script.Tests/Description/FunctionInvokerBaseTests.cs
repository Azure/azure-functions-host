...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class FunctionInvokerBaseTests : IDisposable
    {
        ...
        internal class MockMetadataManager : IFunctionMetadataManager
        {
            ...
            public ImmutableArray<FunctionMetadata> GetFunctionMetadata(bool forceRefresh = false, bool applyAllowlist = true, bool includeCustomProviders = true, IList<RpcWorkerConfig> configs = null)
            {
