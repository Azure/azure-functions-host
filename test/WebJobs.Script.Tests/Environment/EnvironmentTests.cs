...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class EnvironmentTests
    {
        ...
        [InlineData("website-instance-id", "", "", "InvalidSku", false, false)]
        [InlineData("", "container-name", "1", "FlexConsumption", false, true)]
        [InlineData("", "container-name", "", "", true, false)]
        [InlineData("", "container-name", "a", "FlexConsumption", false, true)]
        [InlineData(null, "container-name", "", "", true, false)]
        [InlineData("", "", "", "", false, false)]
        [InlineData(null, "", null, "", false, false)]
        [InlineData("", null, null, "", false, false)]
        [InlineData(null, null, null, "",  false, false)]
        public void Returns_IsLinuxConsumption(string websiteInstanceId, string containerName, string legionServiceHost, string flexConsumptionSku, bool isLinuxConsumptionOnAtlas, bool isLinuxConsumptionOnLegion)
        {
            var testEnvironment = new TestEnvironment();
            ...
            testEnvironment.SetEnvironmentVariable(EnvironmentSettingNames.WebsiteSkuName, flexConsumptionSku);
