...
namespace Microsoft.Azure.WebJobs.Script.Tests.FileAugmentation
{
    public class FuncAppFileProvisioningServiceTests
    {
        ...
        public async Task Readonly_FunAppRoot_Test()
        {
            ...
            var logger = new LoggerFactory().CreateLogger<FuncAppFileProvisioningService>();
            var funcAppFileProvisioningService = new FuncAppFileProvisioningService(_environment, _optionsMonitor, _funcAppFileProvisionerFactory, logger);
