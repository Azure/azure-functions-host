...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    ...
    public class UtilityTests
    {
        ...
        [Fact]
        public async void Test_LogAutorestGeneratedJson_Without_AutorestGeneratedJson()
        {
        ...
        [Theory]
        [InlineData("{\"name\":\"@autorest/azure-functions-csharp\",\"version\":\"0.2.0-preview\"}", "autorest_generated.json file found generated by Autorest (https://aka.ms/stencil) | file content:\n{\n  \"name\": \"@autorest/azure-functions-csharp\",\n  \"version\": \"0.2.0-preview\"\n}", LogLevel.Information)]
        ...
        public async void Test_LogAutorestGeneratedJson_With_AutorestGeneratedJson(string autorestGeneratedJsonContent, string expectedContents, LogLevel expectedLogLevel)
        {
            string functionAppDirectory = GetTemporaryDirectory();
            try
            {
