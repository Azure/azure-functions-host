...
{
    public class WorkerCongurationResolverTests : IDisposable
    {
        private TestEnvironment _testEnvironment;

        public WorkerCongurationResolverTests()
        {
        ...
        public void DefaultLanguageWorkersDir()
        {
            ...
            {
                new DefaultWorkerConfigurationProvider(testLoggerFactory, testMetricLogger, FileUtility.Instance, testProfileManager.Object, SystemRuntimeInformation.Instance, optionsMonitor)
            };
        ...
        public void LanguageWorker_WorkersDir_Set()
        {
            ...
            var providers = new List<IWorkerConfigurationProvider>
            {
                new DefaultWorkerConfigurationProvider(mockLogger.Object, testMetricLogger, FileUtility.Instance, testProfileManager.Object, SystemRuntimeInformation.Instance, optionsMonitor)
            };
        ...
        public void WorkerDescription_Skipped_When_Profile_Disables_Worker()
        {
            ...
            var testPath = Path.GetDirectoryName(new Uri(typeof(WorkerCongurationResolverTests).Assembly.Location).LocalPath);
        ...
        public void DefaultWorkerConfigs_Overrides_DefaultWorkerRuntimeVersion_AppSetting(string setting, string output)
        {
            ...
            var providers = new List<IWorkerConfigurationProvider>
            {
                new DefaultWorkerConfigurationProvider(loggerFactory, testMetricLogger, FileUtility.Instance, workerProfileManager, SystemRuntimeInformation.Instance, optionsMonitor)
            };
        ...
        public void DefaultWorkerConfigs_Overrides_VersionAppSetting(string setting, string output)
        {
            ...
            var testLogger = loggerFactory.CreateLogger("test");
            var testScriptHostManager = new Mock<IScriptHostManager>();
            var optionsMonitor = WorkerConfigurationResolverTestsHelper.GetTestWorkerConfigurationResolverOptions(config, testEnvironment, testScriptHostManager.Object, null);
        ...
        public void GetWorkerProcessCount_Tests(bool defaultWorkerConfig, bool setProcessCountToNumberOfCpuCores, bool setWorkerCountInEnv, int minProcessCount, int maxProcessCount, string processStartupInterval)
        {
            ...
            var result = WorkerConfigurationProviderBase.GetWorkerProcessCount(workerConfig, _testEnvironment.GetEnvironmentVariable(RpcWorkerConstants.FunctionsWorkerProcessCountSettingName), _testEnvironment.GetEffectiveCoresCount());
        ...
        public void GetWorkerProcessCount_ThrowsException_Tests()
        {
            ...
            var resultEx1 = Assert.Throws<ArgumentOutOfRangeException>(() => WorkerConfigurationProviderBase.GetWorkerProcessCount(workerConfig, _testEnvironment.GetEnvironmentVariable(RpcWorkerConstants.FunctionsWorkerProcessCountSettingName), _testEnvironment.GetEffectiveCoresCount()));
            ...
            var resultEx2 = Assert.Throws<ArgumentException>(() => WorkerConfigurationProviderBase.GetWorkerProcessCount(workerConfig, _testEnvironment.GetEnvironmentVariable(RpcWorkerConstants.FunctionsWorkerProcessCountSettingName), _testEnvironment.GetEffectiveCoresCount()));
            ...
            var resultEx3 = Assert.Throws<JsonException>(() => WorkerConfigurationProviderBase.GetWorkerProcessCount(workerConfig, _testEnvironment.GetEnvironmentVariable(RpcWorkerConstants.FunctionsWorkerProcessCountSettingName), _testEnvironment.GetEffectiveCoresCount()));
