...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class FunctionMetadataManagerTests
    {
        ...
        public void FunctionMetadataManager_Verify_FunctionErrors(string scriptFile)
        {
            ...
            mockFunctionMetadataProvider.Setup(m => m.GetFunctionMetadataAsync(It.IsAny<IEnumerable<RpcWorkerConfig>>(), false)).Returns(functionMetadataCollection.ToImmutableArray());
        ...
        public void FunctionMetadataManager_Verify_FunctionErrors_FromFunctionProviders(string scriptFile)
        {
            ...
            mockFunctionMetadataProvider.Setup(m => m.GetFunctionMetadataAsync(workerConfigs, false)).Returns(new Collection<FunctionMetadata>().ToImmutableArray());
