...
namespace Microsoft.Azure.WebJobs.Host.EndToEndTests
{
    ...
    public class BlobStorageConcurrencyStatusRepositoryTests
    {
        ...
        public BlobStorageConcurrencyStatusRepositoryTests()
        {
            ...
            _repository = new BlobStorageConcurrencyStatusRepository(configuration, _mockHostIdProvider.Object, _loggerFactory, azureStorageProvider);
        }
        ...
        public async Task NoStorageConnection_HandledGracefully()
        {
            ...
            var localRepository = new BlobStorageConcurrencyStatusRepository(configuration, _mockHostIdProvider.Object, _loggerFactory, azureStorageProvider);
