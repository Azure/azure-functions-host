...
namespace Microsoft.Azure.WebJobs.Script.Tests.Integration.ContainerManagement
{
    ...
    public class LegionContainerInitializationHostServiceTests : IDisposable
    {
        ...
        public LegionContainerInitializationHostServiceTests()
        {
        ...
        public async Task Runs_In_Linux_Container_Mode_Only()
        {
            ...
            var initializationHostService = new LegionContainerInitializationHostService(_environment, _instanceManagerMock.Object, NullLogger<LinuxContainerInitializationHostService>.Instance, _startupContextProvider);
        ...
        public async Task Does_Not_Run_In_Linux_Container_On_Atlas()
        {
            ...
            Assert.False(_environment.IsLinuxConsumptionOnLegion());
