...
namespace Microsoft.Azure.WebJobs.Script.Tests.Integration.ContainerManagement
{
    ...
    public class LinuxContainerInitializationHostServiceTests : IDisposable
    {
        ...
        public async Task Runs_In_Linux_Container_Mode_Only()
        {
            ...
            var initializationHostService = new AtlasContainerInitializationHostService(_environment, _instanceManagerMock.Object, NullLogger<LinuxContainerInitializationHostService>.Instance, _startupContextProvider);
        ...
        //    var initializationHostService = new Mock<AtlasContainerInitializationHostService>(MockBehavior.Strict, _environment, _instanceManagerMock.Object, NullLogger<LinuxContainerInitializationHostService>.Instance, _startupContextProvider);
