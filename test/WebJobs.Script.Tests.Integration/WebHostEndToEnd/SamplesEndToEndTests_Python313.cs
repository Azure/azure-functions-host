...
namespace Microsoft.Azure.WebJobs.Script.Tests.EndToEnd
{
    ...
    public class SamplesEndToEndTests_Python313 : IClassFixture<SamplesEndToEndTests_Python313.TestFixture>
    {
        private readonly ScriptSettingsManager _settingsManager;
        private TestFixture _fixture;

        public SamplesEndToEndTests_Python313(TestFixture fixture)
        {
            _fixture = fixture;
