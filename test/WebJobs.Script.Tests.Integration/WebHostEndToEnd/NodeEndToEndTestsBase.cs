...
namespace Microsoft.Azure.WebJobs.Script.Tests.EndToEnd
{
    ...
    public abstract class NodeEndToEndTestsBase<TFixture> : EndToEndTestsBase<TFixture> where TFixture : EndToEndTestFixture
    {
        protected NodeEndToEndTestsBase(TFixture fixture) : base(fixture) { }
