...
namespace Microsoft.Azure.WebJobs.Script.Tests.EndToEnd
{
    ...
    public class SamplesEndToEndTestsSingleLanguage : IClassFixture<SamplesEndToEndTestsSingleLanguage.TestFixture>
    {
        private readonly ScriptSettingsManager _settingsManager;
        private TestFixture _fixture;

        public SamplesEndToEndTestsSingleLanguage(TestFixture fixture)
        {
            _fixture = fixture;
        ...
        public class TestFixture : EndToEndTestFixture
        {
            ...
            public TestFixture()
                : base(Path.Combine(Environment.CurrentDirectory, @"..\..\..\..\..\sample\NodeSamples"), "NodeSamples", functionsWorkerRuntime: null)
            {
            }
