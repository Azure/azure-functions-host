    ...
    public class SamplesEndToEndTests : IClassFixture<SamplesEndToEndTests.TestFixture>
    {
        ...
        public async Task HostStatus_AnonymousAntaresInteral_CheckLoad_Succeeds()
        {
            ...
            var vars = new Dictionary<string, string>
            {
                ...
                { HostPerformanceManager.WebsiteAppCountersEnvironmentVariableName, "{\"connections\": 290, \"connectionLimit\": 300}" }
            };
        ...
        public async Task HostStatus_AdminLevelRequest_WithLoad_Succeeds()
        {
            try
            {
                ...
                Environment.SetEnvironmentVariable(HostPerformanceManager.WebsiteAppCountersEnvironmentVariableName, counters.ToString());
            ...
            {
                Environment.SetEnvironmentVariable(HostPerformanceManager.WebsiteAppCountersEnvironmentVariableName, string.Empty);
            }
        }
