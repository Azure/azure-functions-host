...
{
    /// <summary>
    /// Test verifying the Static Web Apps deployment configuration.
    /// </summary>
    public class SWAEndToEndTests : IClassFixture<SWAEndToEndTests.TestFixture>
    {
        ...
        public async Task InvokeFunction_AnonymousLevel_Succeeds()
        {
            ...
            var response = await _fixture.Host.HttpClient.PostAsync("api/HttpTrigger-Scenarios?code=test", content);
        ...
        public class TestFixture : EndToEndTestFixture
        {
            ...
            public TestFixture() : base(@"TestScripts\CSharp", "csharp", RpcWorkerConstants.DotNetLanguageWorkerName)
            {
                ...
                var settings = new Dictionary<string, string>()
                {
                    ...
                    { EnvironmentSettingNames.AzureWebsiteName, "somewebsite" }
                };
            ...
            public override void ConfigureScriptHost(IServiceCollection services)
            {
                ...
                services.TryAddSingleton<IFunctionsSyncManager, FunctionsSyncManager>();
            }
