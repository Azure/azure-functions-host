![Azure Functions Logo](https://raw.githubusercontent.com/Azure/azure-functions-cli/main/eng/tools/publish-tools/npm/assets/azure-functions-logo-color-raster.png)
