...
if($sourceBranch.endsWith('release/2.0-hotfix-77')) {
  $suffix = ""
}

if(($sourceBranch.endsWith('v2.x') -or $sourceBranch.endsWith('release/2.0-hotfix-77')) -and ($buildReason -ne "PullRequest"))
{
