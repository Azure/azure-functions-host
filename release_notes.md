...
- Removed the `test_data` and `test_data_href` properties from the functions metadata API response and stopped persisting test data on function create/update. Existing test data files remain accessible via `/admin/vfs`. (#TBD)
