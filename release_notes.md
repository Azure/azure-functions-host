...
- Add support for standalone executable (ie: `dotnet build --standalone`) for out-of-proc workers in Linux Consumption. ([#9550](https://github.com/Azure/azure-functions-host/pull/9550))
